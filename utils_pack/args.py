...
def get_args():
    ...
    parser.add_argument('--pretrain_epochs', type=int, default=20, help='number of pretraining epochs')
    parser.add_argument('--joint_epochs', type=int, default=30, help='number of joint training epochs')
    parser.add_argument('--finetune_epochs', type=int, default=20, help='number of fine-tuning epochs')
    parser.add_argument('--lambda_recon', type=float, default=0.7, help='reconstruction loss weight')
    ...
    parser.add_argument('--model', type=str, default='WaveRec_road_map_v5_bj',
